...
var MenuItem = /** @class */ (function (_super) {
    ...
    MenuItem.prototype.render = function () {
        ...
        var anchorClasses = classnames_1.default(Classes.MENU_ITEM, intentClass, (_a = {},
            ...
            _a), className);
        var target = React.createElement(tagName, tslib_1.__assign({}, htmlProps, (disabled ? DISABLED_PROPS : {}), { className: anchorClasses }), React.createElement(icon_1.Icon, { icon: icon }), React.createElement(text_1.Text, { className: classnames_1.default(Classes.FILL, textClassName), ellipsize: !multiline }, text), this.maybeRenderLabel(labelElement), hasSubmenu ? React.createElement(icon_1.Icon, { icon: "caret-right" }) : undefined);
        var liClasses = classnames_1.default((_b = {}, _b[Classes.MENU_SUBMENU] = hasSubmenu, _b));
