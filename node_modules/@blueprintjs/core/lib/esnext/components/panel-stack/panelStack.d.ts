...
export declare class PanelStack extends AbstractPureComponent<IPanelStackProps, IPanelStackState> {
    state: IPanelStackState;
    componentWillReceiveProps(nextProps: IPanelStackProps): void;
    render(): JSX.Element;
